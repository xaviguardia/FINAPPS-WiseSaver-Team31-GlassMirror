...
namespace instacollect.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var usuarios = context.UserProfiles.ToList();
            var vm = new UserListModel()
            {
        ...
        {
            var context = new UsersContext();
            var usuario = context.UserProfiles.Find(UserId);
            var role = context.UserRoles.Find(RoleId);
